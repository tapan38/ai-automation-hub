...
// For dynamic data, populate this array or use a CMS export

type NotionCategory = 'Template' | 'Affiliate' | 'App' | 'Knowledge' | 'Tools' | 'Webinar';
...
const allProducts: NotionItem[] = [
  ...
  },
  {
    ...
    description: 'A comprehensive guide to building effective skills for Claude, teaching you how to customize AI workflows for specific tasks.',
