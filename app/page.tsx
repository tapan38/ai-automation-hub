...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-warm-beige">
        ...
        <div className="container-width text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-lg md:text-xl text-warm-gray max-w-2xl mx-auto leading-relaxed">
              Master workflow automation, n8n templates, and AI agents. 
              Save 10+ hours every week with battle-tested automation templates.
            </p>
      ...
      {/* Freebies & Templates Section */}
      <section id="templates" className="section-padding bg-soft-cream/50">
        <div className="container-width">
          <div className="text-center mb-12">
            ...
            <p className="text-warm-gray max-w-2xl mx-auto">
              Ready-to-use automation templates and Notion systems to supercharge your productivity.
            </p>
          </div>
          ...
          {templates.length === 0 && (
            <div className="text-center py-12">
              <p className="text-warm-gray">
                No templates found. Add some in your Notion database!
              </p>
            </div>
          )}
        </div>
      ...
      <section id="playbook" className="section-padding">
        <div className="container-width">
          <div className="text-center mb-12">
            ...
            <p className="text-warm-gray max-w-2xl mx-auto">
              Curated AI tools and software I personally use and recommend.
            </p>
          </div>
          ...
          {affiliates.length === 0 && (
            <div className="text-center py-12">
              <p className="text-warm-gray">
                No partner tools found. Add some in your Notion database!
              </p>
            </div>
          )}
        </div>
      ...
      <section className="section-padding bg-deep-charcoal text-white">
        <div className="container-width text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Join 2,000+ Automation Enthusiasts
          </h2>
          <p className="text-white/70 max-w-xl mx-auto mb-8">
            Get weekly guides on AI automation, n8n workflows, and productivity hacks.
